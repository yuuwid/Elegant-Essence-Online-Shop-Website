    ...
    <div class="p-4 sm:ml-64 mt-20">
        ...
        <div class="flex justify-center">
            ...
            <div class="w-full mt-2 max-w-3xl border p-8 shadow-lg rounded-md">
                ...
                <form method="POST" action="/admin/dashboard/list-categories/h/add" enctype="multipart/form-data">
                    @csrf
                    <div class="flex justify-center">
                        <div class="ms-6">
                            <div
                            ...
                            class="w-32 h-32 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center" @endif>
                                ...
                                <div id="previewContainer" class="w-32 h-32 bg-cover hidden cursor-pointer">
                                    <img id="logoCategoryPreviewImage" class="w-32 h-32 bg-cover" alt="Preview Image">
                                </div>
                            </div>
                    ...
                    <div class="mt-6 text-center">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <input id="category_name" type="text" name="category" value="{{ old('category') }}"
