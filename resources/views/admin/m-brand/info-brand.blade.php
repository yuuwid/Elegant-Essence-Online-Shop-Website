                        ...
                        <div class="ms-6">
                            ...
                            class="w-32 h-32 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center" @endif>
                                ...
                                <div id="previewContainer" class="w-32 h-32 bg-cover  cursor-pointer">
                                    <img src="/{{ $brand->logo }}" id="logoBrandPreviewImage" class="w-32 h-32 bg-cover"
                                        alt="Preview Image">
                                </div>
                            </div>
                    ...
                    <div class="mt-6 text-center">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                ...
                                <input type="hidden" name="slug_brand" value="{{ $brand->slug_brand }}">
                            @endif
                        </div>
                    </div>
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                        Ingin Menghapus Brand: {{ $brand->brand }} ?
                    </h3>
                    <form action="/admin/dashboard/list-brand/h/delete/{{ $brand->slug_brand }}" method="post">
                        @csrf
