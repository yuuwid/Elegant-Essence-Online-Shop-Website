...
@section('content')
    ...
    <div class="p-4 sm:ml-64 mt-20">
        ...
        <div class="flex justify-between p-4 items-center">
            ...
            <div class="">
                <a href="/admin/dashboard/list-brand/m/add"
        ...
        <div class="w-full px-4 pb-4 py-2">
            <form action="/admin/dashboard/list-brand/search" method="GET">
        ...
        <div class="w-full px-4">
            <div class="grid grid-cols-2 sm:!grid-cols-4 md:!grid-cols-6 lg:!grid-cols-8 gap-3">
                @foreach ($brands as $b)
                    <a href="/admin/dashboard/list-brand/m/view/{{ $b->slug_brand }}"
                        class="border shadow-md rounded max-w-xs group">
                        <div class="flex justify-center overflow-hidden">
                            <img class="rounded-t-lg w-32 h-32 group-hover:scale-110" src="{{ '/' . $b->logo }}"
                                alt="" />
                        </div>
