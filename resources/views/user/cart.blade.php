    ...
    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col gap-0.5">
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center justify-center gap-1">
                                    <i class="text-gray-400 bi bi-patch-minus text-xl"></i>
                                    <span class="border border-gray-300 px-3 leading-none">01</span>
                                    <i class="text-green-400 bi bi-patch-plus text-xl"></i>
                                </div>
        ...
        <div>
            <div class="bg-white rounded-md shadow-md p-2">
                <h3 class="text-black font-medium uppercase">Order Detail</h3>

                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Subtotal</span>
                    <span class="text-gray-800 font-bold">$743</span>
                </div>
                ...
                <div class="mb-1 flex justify-between items-center">
                    ...
                    <span class="text-gray-800 font-bold">$777</span>
                </div>

                <button
                    class="bg-e2-blue-700 text-white font-bold text-center w-full py-1 rounded shadow">CHECKOUT</button>
